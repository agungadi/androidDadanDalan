...
import com.agungadi.myapplication.Helper.JembatanInterface;
...
public class JembatanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationListener ll = new mylocationlistener2();
    ...
    public void submitReport() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(JembatanInterface.JEMBATANIURL)
                .addConverterFactory(ScalarsConverterFactory.create())
                .build();

        JembatanInterface api = retrofit.create(JembatanInterface.class);


        Call<String> call = api.getJEMBATAN(id, image, alamat, deskripsi, kecamatan, latitude, longtitude);
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        Toast.makeText(JembatanActivity.this, "Laporan Terkirim", Toast.LENGTH_LONG).show();

                    } else {
                        Log.i("onEmptyResponse", "Returned empty response");
                        Toast.makeText(JembatanActivity.this, "Nothing returned", Toast.LENGTH_LONG).show();
                    }
                }
